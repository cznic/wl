...
/*
	...
	$ grep ^[A-Z] prec.go | grep -v package | tac
...
MAP	expr1/@expr2	Map[expr1,expr2]	e/@(e/@e)	⊲
MAPALL	expr1//@expr2	MapAll[expr1,expr2]	e//@(e//@e)	⊲
APPLY	expr1@@expr2	Apply[expr1,expr2]	e@@(e@@e)	⊲
...
UNARY_MINUS	-expr	Times[-1,expr]		⊲
	...
	±expr	PlusMinus[expr]
	∓expr	MinusPlus[expr]
DIV	expr1/expr2	expr1(expr2)^-1	(e/e)/e	⊲
...
MUL	expr1*expr2*expr3	Times[expr1,expr2,expr3]	e*e*e	⊲
	expr1×expr2×expr3	Times[expr1,expr2,expr3]	e×e×e	⊲
...
ADD	expr1+expr2+expr3	Plus[expr1,expr2,expr3]	e+e+e	⊲
MINUS	expr1-expr2	expr1+(-1expr2)	(e-e)-e	⊲
...
EQUAL	expr1==expr2	Equal[expr1,expr2]	e==e==e	⊲
	expr1==expr2	Equal[expr1,expr2]	e==e==e	⊲
	expr1expr2	Equal[expr1,expr2]	eee	⊲
	expr1!= expr2	Unequal[expr1,expr2]	e!=e!=e	⊲
	expr1!=expr2	Unequal[expr1,expr2]	e!=e!=e	⊲
	other equality and similarity operators
GT	expr1>expr2	Greater[expr1,expr2]	e>e>e	⊲
GEQ	expr1>=expr2	GreaterEqual[expr1,expr2]	e>=e>=e	⊲
	expr1≥expr2	GreaterEqual[expr1,expr2]	e≥e≥e	⊲
	expr1⩾expr2	GreaterEqual[expr1,expr2]	e⩾e⩾e	⊲
LESS	expr1<expr2	Less[expr1,expr2]	e<e<e	⊲
LEQ	expr1<=expr2	LessEqual[expr1,expr2]	e<=e<=e	⊲
...
SAME	expr1===expr2	SameQ[expr1,expr2]	e===e===e	⊲
UNSAME	expr1=!=expr2	UnsameQ[expr1,expr2]	e=!=e=!=e	⊲
...
ASSIGN	expr1=expr2	Set[expr1,expr2]	e=(e=e)	⊲
SET_DELAYED	expr1:=expr2	SetDelayed[expr1,expr2]	e:=(e:=e)	⊲
